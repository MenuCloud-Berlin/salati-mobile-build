...
Gebetszeiten, Qibla, Koran mit Audio, KI & Lesenlernen — werbefrei, ohne Konto

(78/80 Zeichen)

## Vollständige Beschreibung

Salati begleitet dich durch deinen Tag als Muslim — mit genauen Gebetszeiten, dem Koran, einer privaten KI und einem kompletten Kurs, um Koranlesen von Grund auf zu lernen. Werbefrei, ohne Konto und ohne Tracking.

GEBET & ALLTAG
• Gebetszeiten mit wählbaren Berechnungsmethoden und Benachrichtigungen
• Qibla-Kompass und Hijri-Kalender
• Gebets-Tracker mit Serie — behalte deine fünf Gebete im Blick
• Fasten-Modus mit Suhoor- und Iftar-Countdown, Qada-Zähler für nachzuholende Tage
• Zakat-Rechner mit jährlicher Stichtag-Erinnerung
• Moschee-Finder (OpenStreetMap) und Halal in der Nähe
...
• Läuft zu 100 % lokal auf deinem Gerät (Web- und native On-Device-Version) — kein Cloud-Zugriff, keine Daten verlassen dein Gerät
• Kennzeichnung: KI-generierte Antwort, keine Fatwa oder Gelehrten-Meinung
...
islam,muslim,adhan,gebet,dua,hadith,tasbih,ramadan,zakat,hijri,moschee,quran,fasten,hifz

(88/100 Zeichen)

## App-Store-Untertitel

Gebetszeiten, Qibla & Koran
